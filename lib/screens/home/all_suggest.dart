...
class AllSuggestScreen extends StatefulWidget {
  const AllSuggestScreen({super.key});

  @override
  State<AllSuggestScreen> createState() => _AllSuggestScreenState();
}

List sliderList = [];

class _AllSuggestScreenState extends State<AllSuggestScreen> {
